...
export const penObj: pen[] = [
  ...
  },
  {
    ...
    dungeonPenSpeed: 500,
    penGamePenSpeed: 500,
    rewardList: [100, 200, 300, 400, 500, 700],
  },
  {
    title: '컴퓨터용 사인펜',
    desc: 'OMR카드를 가져와',
    ...
    dungeonPenSpeed: 500,
    penGamePenSpeed: 500,
    rewardList: [500, 500, 1000, 500, 600, 500],
  },
  {
    title: '보드마카',
    desc: '두툼한 보드마카',
    ...
    dungeonPenSpeed: 500,
    penGamePenSpeed: 500,
    rewardList: [1500, 100, 200, 200, 300, 500],
  },
  {
    title: '유성매직',
    desc: '기념품입니다.',
    ...
    dungeonPenSpeed: 500,
    penGamePenSpeed: 500,
    rewardList: [2500, 400, 1000, 1000, 500, 1000],
  },
  {
    title: '만년필',
    desc: '기념품입니다.',
    ...
    dungeonPenSpeed: 500,
    penGamePenSpeed: 500,
    rewardList: [3500, 400, 300, 100, 500, 100],
  },

  {
    ...
    dungeonPenSpeed: 500,
    penGamePenSpeed: 500,
    rewardList: [10000, 1000, 500, 1000, 3000, 1000],
  },
];
