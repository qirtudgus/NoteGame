CREATE TABLE `users` (
   ...
   `EquipBallpen` varchar(45) COLLATE utf8mb4_bin NOT NULL DEFAULT 'weapon1',
   `BuyBallpenList` varchar(500) COLLATE utf8mb4_bin NOT NULL DEFAULT 'weapon1',
   PRIMARY KEY (`Index`)
 ) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='유저 테이블\n유저번호 / 닉네임 / 비밀번호 /레벨 / 기본 공격력 / 기본 체력 / 무기 공격력 / 방어구 체력 / 장착중인 무기 / 장착중인 방어구 / 화폐 / 각 스킬의 레벨 / 가지고 있는 아이템 / 볼펜 돌린 횟수 / 사냥 횟수'