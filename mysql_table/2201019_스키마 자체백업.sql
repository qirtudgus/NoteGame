...
CREATE TABLE `monstercollection` (
  ...
  `m00001` int NOT NULL DEFAULT '0',
  `m00002` int NOT NULL DEFAULT '0',
  `m00003` int NOT NULL DEFAULT '0',
  `m00004` int NOT NULL DEFAULT '0',
  `m00005` int NOT NULL DEFAULT '0',
  `m00006` int NOT NULL DEFAULT '0',
  `m00007` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`Index`)
...
INSERT INTO `monstercollection` VALUES (6,'sott',0,0,0,0,0,0,0),(7,'12',0,0,0,0,0,0,0);
...
CREATE TABLE `monstercount` (
  `Index` int NOT NULL AUTO_INCREMENT,
  `Id` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
  `m00001` int NOT NULL DEFAULT '0',
  `m00002` int NOT NULL DEFAULT '0',
  `m00003` int NOT NULL DEFAULT '0',
  `m00004` int NOT NULL DEFAULT '0',
...
INSERT INTO `monstercount` VALUES (5,'sott',0,0,0,0,0,0,0),(6,'12',0,0,0,0,0,0,0);
...
-- Dump completed on 2022-10-19 18:05:34
